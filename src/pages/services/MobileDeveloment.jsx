...
const MobileDeveloment = () => {
  return (
    <div className="flex flex-col items-center justify-center px-4">
      ...
      <p className="text-center text-gray-600 max-w-full text-justify mx-auto mb-12 text-xl leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="text-center bg-[#1f3f53] p-6 rounded-lg">
              ...
              <h3 className="text-orange-500 text-xl font-bold mb-3">E-Commerce</h3>
              <p className="text-white text-justify leading-6">
                ...
                a mobile application which facilitates all E-Commerce functions.
              </p>
            </div>
            ...
            <div className="text-center bg-[#1f3f53] p-6 rounded-lg">
              ...
              <h3 className="text-orange-500 text-xl font-bold mb-3">Basic</h3>
              <p className="text-white text-justify leading-6">
                Understanding the right need, at the right time, and targeting the right audience is the essence of successful Business. Question is, how to
                ...
                your audience, with the help of a website or the application which supports mobile too.
              </p>
            </div>
          </div>
        </div>
