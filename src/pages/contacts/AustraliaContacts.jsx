      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-10">
        ...
        <div>
          <p className="px-13 text-xl text-center text-justify text-gray-600">
            We are one of the best SEO company in Noida and ORM company in Noida,
            India. We are also well-known SEO company in Ghaziabad. Website
            Designing Company in Ghaziabad, Noida and Delhi, India. We began our
            operations as Best Digital Marketing Agency in the year 2012 and
            since then have grown by leaps and bounds. From the very beginning,
            we have stayed true to our core beliefs and have delivered an
            exceptional experience for our customers. We have more than 500
            satisfied customers over the globe and delivered more than 1000
            projects in last 12 years. Our expertise in Digital marketing
            services which includes SEO, PPC, SMO and content writing. We have
            made websites and done SEO for Hotels, Hospitals, FMCG companies,
            Doctors, Clinics, Schools and Colleges.
          </p>
        </div>
        ...
        <div>
          <ul className="text-xl space-y-5 text-[#294A63] font-semibold text-sm">
            {services.map((service, i) => (
              <li
                key={i}
                className="flex items-center gap-2 border-b border-gray-600 pb-2 hover:text-orange-400 transition-colors"
              >
                <a
                  href={service.link}
